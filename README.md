...
Replaces Kimi's default context compaction with [Morph's](https://morphllm.com) `morph-compactor` model -- faster and cheaper compaction via the `/v1/compact` endpoint.
